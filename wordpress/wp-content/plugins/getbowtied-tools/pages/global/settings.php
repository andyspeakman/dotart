		...
		*/
		...
		switch ($theme_slug)
		{
			case 'merchandiser':
				...
				$settings['theme_logo']			= GETBOWTIED_TOOLS_URL.'/img/merchandiser.png';
				$settings['demo_image']			= GETBOWTIED_TOOLS_URL.'/img/demos/merchandiser/screenshot.png';
			...
			case 'shopkeeper':
				...
				$settings['options_file_url']	= 'http://my.getbowtied.com/api/shopkeeper/theme_options/theme_options.json';
				$settings['theme_logo']			= GETBOWTIED_TOOLS_URL.'/img/shopkeeper.png';
				$settings['demo_image']			= GETBOWTIED_TOOLS_URL.'/img/demos/shopkeeper/default.png';
			...
			case 'mrtailor':
				...
				$settings['theme_logo']			= GETBOWTIED_TOOLS_URL.'/img/mr_tailor.png';

				// DEFAULT DEMO
				$settings['demo_image']			= GETBOWTIED_TOOLS_URL.'/img/demos/mr_tailor/main-demo.jpg';
				...
				// INDIE STORE
				$settings['demo_image_indie']			= GETBOWTIED_TOOLS_URL.'/img/demos/mr_tailor/indie-store.jpg';
				...
				// STARTUP
				$settings['demo_image_startup']			= GETBOWTIED_TOOLS_URL.'/img/demos/mr_tailor/startup-demo.jpg';
			...
			case 'theretailer':
				...
				$settings['theme_logo']			= GETBOWTIED_TOOLS_URL.'/img/the_retailer.png';
				$settings['demo_image']			= GETBOWTIED_TOOLS_URL.'/img/demos/the_retailer/default.png';
